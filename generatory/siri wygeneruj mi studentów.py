...
def generator_studenciakow(path, N, idMin, idMax):
    max_stud = 5660
    ...
    majors = [
        ...
        ["Automatyzacja i robotyzacja procesów produkcyjnych", "Mechaniczny Technologiczny", "120", "Warszawa",
         "polski",
         "528"],
        ...
        ["Inżynieria pojazdów elektrycznych i hybrydowych", "Samochodów i Maszyn Roboczych", "100", "Warszawa",
         "polski",
         "2777"],
        ...
        ["Mechatronika pojazdów i maszyn roboczych", "Samochodów i Maszyn Roboczych", "50", "Warszawa", "polski",
         "3765"],
        ["Ochrona środowiska", "Instalacji Budowlanych, Hydrotechniki i Inżynierii Środowiska", "60", "Warszawa",
         "polski",
         "3825"],
    ...
    students_id_pool = list(range(idMin, idMax))
    ...
    with open(path, "w") as file:
        for i in range(N):
            ...
            if preference_dorm == "Riviera" or preference_location == "Kampus Centralny":
                ...
                preference_ad = False
            if random.random() < 1 / 4:
                preference_tenant = random.randint(idMin, idMax)
            else:
